					...
					<div id="postbox-container-2" class="postbox-container">
						<div class="meta-box-sortables">
							<?php if (empty($this->get_feed_id())) : ?>
								<?php _e('No XML feed found', 'yfym'); ?>. <?php _e('Click the "Add New Feed" button at the top of this page', 'yfym'); ?>.
							<?php else:
					...
					<tr>
						...
						<td class="overalldesc">
							<select name="yfym_format_date" id="yfym_format_date">
								<option value="rfc_short" <?php selected($yfym_format_date, 'rfc_short'); ?>>RFC 3339 short (2022-03-21T17:47) (<?php _e('recommend', 'yfym'); ?>)</option>	
		...
		<div class="metabox-holder">
			<div class="postbox">
				...
				<div class="inside">
					...
					<p><span class="yfym_bold">Integrate myTarget for WooCommerce</span> - <?php _e('This plugin helps setting up myTarget counter for dynamic remarketing for WooCommerce', 'yfym'); ?>. <a href="https://wordpress.org/plugins/wc-mytarget/" target="_blank"><?php _e('Read more', 'yfym'); ?></a>.</p>
